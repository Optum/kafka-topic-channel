...
import (
	...
	"github.com/optum/kafka-topic-channel/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type MessagingV1alpha1Interface interface {
	RESTClient() rest.Interface
	KafkaTopicChannelsGetter
}

// MessagingV1alpha1Client is used to interact with features provided by the messaging.optum.dev group.
type MessagingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MessagingV1alpha1Client) KafkaTopicChannels(namespace string) KafkaTopicChannelInterface {
	return newKafkaTopicChannels(c, namespace)
}
