...
import (
	...
	versionedscheme "github.com/optum/kafka-topic-channel/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "kafkatopicchannel-controller"
	defaultFinalizerName       = "kafkatopicchannels.messaging.optum.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kafkatopicchannelInformer := kafkatopicchannel.Get(ctx)

	lister := kafkatopicchannelInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "messaging.optum.dev.KafkaTopicChannel"),
	)
