...
func NewDispatcher(ctx context.Context, args *KafkaDispatcherArgs) (*KafkaDispatcher, error) {
	producer, err := sarama.NewSyncProducer(args.Brokers, args.KafkaConfig)
	if err != nil {
	...
	dispatcher := &KafkaDispatcher{
		...
		kafkaConsumerFactory: consumer.NewConsumerGroupFactory(args.Brokers, args.KafkaConfig),
