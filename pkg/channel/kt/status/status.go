...
type targetState struct {
	...
	ch  messagingv1alpha1.KafkaTopicChannel
...
type Prober struct {
	...
	readyCallback func(messagingv1alpha1.KafkaTopicChannel, eventingduckv1.SubscriberSpec)
...
func (m *Prober) IsReady(ctx context.Context, ch messagingv1alpha1.KafkaTopicChannel, sub eventingduckv1.SubscriberSpec) (bool, error) {
...
func (m *Prober) probeTarget(ctx context.Context, ch messagingv1alpha1.KafkaTopicChannel, sub eventingduckv1.SubscriberSpec, target *ProbeTarget) {
