...
func assertNeverReady(t *testing.T, prober *Prober, ch *messagingv1alpha1.KafkaTopicChannel, sub *eventingduckv1.SubscriberSpec, ready chan *ReadyPair, probeRequests *chan *http.Request) {
...
func assertEventuallyReady(t *testing.T, prober *Prober, ch *messagingv1alpha1.KafkaTopicChannel, sub *eventingduckv1.SubscriberSpec, ready chan *ReadyPair, succeed *atomic.Bool, probeRequests *chan *http.Request) {
...
func getChannel(partitionsNum int32) *v1alpha1.KafkaTopicChannel {
	return (&v1alpha1.KafkaTopicChannel{
...
func (l fakeProbeTargetLister) ListProbeTargets(ctx context.Context, kc messagingv1alpha1.KafkaTopicChannel) (*ProbeTarget, error) {
	return l.target, nil
}

type notFoundLister struct{}

func (l notFoundLister) ListProbeTargets(ctx context.Context, kc messagingv1alpha1.KafkaTopicChannel) (*ProbeTarget, error) {
